...
<title>Examen de Admision "Colegio Panamericana"</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Examen de Admision "Colegio Panamericana"</span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Postulante</b></a>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     " width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 ...
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px" >Aranyz-Sys</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Plataforma E-learning</h4>
		<h4 style="font-family:'typo' ">Frans Paxi Juchani</h4>
		<h4 style="font-family:'typo' ">Alex Jossmel Quispe</h4>
    <h4 style="font-family:'typo' ">Anthony Alcahuasi</h4></div></div>
		</p>
      </div>
